...
#if defined(_WIN32)
#define GREIO_SHARED_EXPORT __declspec( dllexport )
#else
#define GREIO_SHARED_EXPORT
#endif
 ...
 */
GREIO_SHARED_EXPORT void gre_io_close(gre_io_t *handle);
 ...
 */
GREIO_SHARED_EXPORT int gre_io_send(gre_io_t *handle, gre_io_serialized_data_t *buffer);
 ...
 */
GREIO_SHARED_EXPORT int gre_io_receive(gre_io_t *handle, gre_io_serialized_data_t **buffer);
 ...
 * @return -1 on failure anything else is success
 */
GREIO_SHARED_EXPORT int gre_io_grow_buffer(gre_io_t *handle, gre_io_serialized_data_t *buffer);
 ...
 */
GREIO_SHARED_EXPORT int gre_io_max_message(gre_io_t *handle);
...
*/
GREIO_SHARED_EXPORT void gre_io_get_error_codes(gre_io_t *handle, gre_io_error_t *errorcodes);
...
*/
GREIO_SHARED_EXPORT const char * gre_io_get_error_message(gre_io_error_t *errorcodes);
 ...
 */
GREIO_SHARED_EXPORT gre_io_serialized_data_t * gre_io_size_buffer(gre_io_serialized_data_t *buffer, int nbytes);
 ...
 */
GREIO_SHARED_EXPORT void gre_io_zero_buffer(gre_io_serialized_data_t *buffer);
 ...
 * @param buffer The buffer to be de-allocated
 */
GREIO_SHARED_EXPORT void                       gre_io_free_buffer(gre_io_serialized_data_t *buffer);
 ...
 */
GREIO_SHARED_EXPORT gre_io_serialized_data_t * gre_io_serialize(gre_io_serialized_data_t *buffer,
 ...
 */
GREIO_SHARED_EXPORT int gre_io_unserialize(gre_io_serialized_data_t *buffer,
                        char **event_target,
                        char **event_name,
                        char **event_format,
                        void **event_data);
 ...
 * @return -1 on failure anything else is success
 */
GREIO_SHARED_EXPORT int gre_io_add_mdata(gre_io_serialized_data_t **mbuffer,
				const char *key_name,
 ...
 * @return -1 on failure anything else is success
 */
GREIO_SHARED_EXPORT int gre_io_send_mdata(gre_io_t *handle, gre_io_serialized_data_t *md_buffer);
 ...
 */
GREIO_SHARED_EXPORT char * greio_array_to_event_data(char **argv, int argc, void **event_data, int *event_data_nbytes);
 ...
 * @return A format string describing the memory block or NULL on failure
 */
GREIO_SHARED_EXPORT char * greio_string_to_event_data(char *data_string, void **event_data, int *event_data_nbytes);
 ...
 */
GREIO_SHARED_EXPORT char * greio_event_data_to_string(char *event_format, void *event_data, int event_data_nbytes);
